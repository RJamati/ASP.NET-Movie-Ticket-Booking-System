...
public partial class website_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //{
        //    DataTable CamaignDetail = CityLogicLayer.GetAllIDWiseCityDetials(Request.Cookies["City"].Value);
        //    if (CamaignDetail.Rows.Count > 0)
        //    {
        //        lnkbtnCityName.InnerText = CamaignDetail.Rows[0]["CityName"].ToString();
        //    }
        //    else
        //    {
        //        mp1.Show();
    ...
    protected void DlForDisplayAccessoricesHeader_ItemDataBound(object sender, DataListItemEventArgs e)
    {
        ...
        innerDataList.DataSource = MoviesLogicLayer.GetAllMoviesDetialsWithTheatresupcoming(Str); 
