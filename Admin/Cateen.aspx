<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cateen.aspx.cs" Inherits="Admin_Controls_feature_master" %>
                ...
                <div class="clear">
                    ...
                    <table runat="server" visible="false" id="TableCellPhoneBrand">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlTheatresName" runat="server" CssClass="select">
                                </asp:DropDownList>
