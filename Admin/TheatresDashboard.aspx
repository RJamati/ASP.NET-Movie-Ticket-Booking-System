<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TheatresDashboard.aspx.cs" Inherits="Admin_Controls_accessory" %>
    ...
    <div class="main">
        <div class="sidebar_pannel">
            ...
            <ul class="buttons">
                ...
                <li><a href="MoviesTheratres.aspx" class="ico4"><span>Movies Master</span><em></em></a> <span class="tooltip">
        ...
        <div class="container">
            ...
            <div class="dashboard">
                 <p style="float:right; font-weight:bold; font-size:16px;padding:6px 0 0 0;"><a href="TheatresDashboard.aspx">Back to Dashboard</a></p>
                <h3>
                  Theatres</h3>
           
                <div class="dashboard_icon">
                    <div class="icon_board">
                        <a href="MoviesTheratres.aspx">
