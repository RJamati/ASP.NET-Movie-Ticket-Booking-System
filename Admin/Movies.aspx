<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Movies.aspx.cs" Inherits="Admin_Controls_feature_master" %>
                ...
                <div class="clear">
                    ...
                    <table runat="server" visible="false" id="TableCellPhoneBrand">
                        ...
                        <tr>
                            ...
                            <td>
                               <asp:TextBox ID="TxtMovieTrailer" runat="server" CssClass="text_box name_box"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="table_header">
