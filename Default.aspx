...
<%@ Register Src="~/UserControl/ViewTrailer.ascx" TagName="Trailer" TagPrefix="UL" %>
...
<body>
    ...
    <div class="main">
        ...
        <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup" align="center" Style="display: none;">
            ...
            <asp:LinkButton runat="server" ID="lBtnCity" Text="Select" Style="display: none; float: right;
margin: 0px 0px 0px 16px;"
                OnClick="lBtnCity_Click"></asp:LinkButton>  
        </asp:Panel>
           <asp:Label runat="server" ID="Label7" style="display:None"></asp:Label>
        <asp:ModalPopupExtender ID="ModalPopupvideo" runat="server" PopupControlID="Panel2"
            TargetControlID="Label7" CancelControlID="LinkButton2" BackgroundCssClass="modalBackground">
        </asp:ModalPopupExtender>
        <asp:Panel ID="Panel2" runat="server" CssClass="modalPopup1" align="center" Style="display: none;">
            <asp:Label runat="server" ID="lblVideo"></asp:Label>
           
            <asp:LinkButton runat="server" ID="LinkButton2" Text="Close"></asp:LinkButton>
        </asp:Panel>
        <div style="background-color: Black; height: 33px;">
            ...
            <div class="login">
                <a href="#" class="login-window">Contact Us</a>
            ...
            <div id="trailer-box" class="login-popup1">
                <UL:Trailer ID="UlTrailer" runat="server" />
            </div>
        ...
        <asp:DataList ID="DlForDisplayAccessoricesHeader" runat="server" OnItemDataBound="DlForDisplayAccessoricesHeader_ItemDataBound">
            <ItemTemplate>
                ...
                <div class="products">
                    <asp:Repeater runat="server" ID="RptAccessories"  OnItemCommand="Rptmovies_ItemCommand">
                        <ItemTemplate>
                            <div class="mobile_images effect8">
                                <%--  <a id="A2" href='<%# String.Format("Booking.aspx?ID={0}", DataBinder.Eval(Container.DataItem, "MoviesId")) %>'
                                    runat="server" class="view_product5" href="#trailer-box">
                                    View Trailer</a>--%>
                                <asp:ImageButton CssClass="img" PostBackUrl='<%# String.Format("Booking.aspx?ID={0}", DataBinder.Eval(Container.DataItem, "MoviesId")) %>'
                                ...
                                <p>
                                    <b>
                                        <asp:LinkButton runat="server" PostBackUrl='<%# String.Format("Booking.aspx?ID={0}", DataBinder.Eval(Container.DataItem, "MoviesId")) %>'
                                ...
                                <a id="A4" href='<%# String.Format("Booking.aspx?ID={0}", DataBinder.Eval(Container.DataItem, "MoviesId")) %>'
                                    runat="server" class="view_product">Book Now</a> 
                                    
                                    <asp:LinkButton  id="ASignup" CommandName="SetVideo" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"MoviesId") %>'
                                        runat="server" class="view_product10">View Trailer</asp:LinkButton>
                                <br />
